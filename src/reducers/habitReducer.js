...
// Create date objects for the next 7 days
const d0 = new Date();
...
// Array representing weekdays with initial doneStatus as an empty string
const weekdays = [
  { day: `${date0} ${month0}`, doneStatus: "" },
  { day: `${date1} ${month1}`, doneStatus: "" },
  { day: `${date2} ${month2}`, doneStatus: "" },
  { day: `${date3} ${month3}`, doneStatus: "" },
  { day: `${date4} ${month4}`, doneStatus: "" },
  { day: `${date5} ${month5}`, doneStatus: "" },
  { day: `${date6} ${month6}`, doneStatus: "" },
];
...
// Reducer function for handling habits state
